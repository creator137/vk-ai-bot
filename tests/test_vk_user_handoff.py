...
class VkUserHandoffTests(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_handler_creates_user_when_actor_id_present(self) -> None:
    ...
    def test_handler_reuses_existing_user_when_actor_id_repeats(self) -> None:
        event = NormalizedVkEvent(
            event_type="message_new",
            group_id=1,
            event_id="evt-1",
    ...
    def test_handler_noops_when_actor_id_is_missing(self) -> None:
        event = NormalizedVkEvent(
